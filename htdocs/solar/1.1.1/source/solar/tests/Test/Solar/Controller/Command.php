 ...
 * 
 */
class Test_Solar_Controller_Command extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Controller_Command = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Controller_Command');
        $this->assertInstance($obj, 'Solar_Controller_Command');
    }
