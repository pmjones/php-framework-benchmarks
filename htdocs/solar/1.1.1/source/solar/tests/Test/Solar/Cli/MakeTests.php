 ...
 * 
 */
class Test_Solar_Cli_MakeTests extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Cli_MakeTests = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Cli_MakeTests');
        $this->assertInstance($obj, 'Solar_Cli_MakeTests');
    }
