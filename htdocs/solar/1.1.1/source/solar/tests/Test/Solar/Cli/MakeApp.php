 ...
 * 
 */
class Test_Solar_Cli_MakeApp extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Cli_MakeApp = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Cli_MakeApp');
        $this->assertInstance($obj, 'Solar_Cli_MakeApp');
    }
