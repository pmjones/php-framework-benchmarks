 ...
 * 
 */
class Test_Solar_Cli_RunTests extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Cli_RunTests = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Cli_RunTests');
        $this->assertInstance($obj, 'Solar_Cli_RunTests');
    }
