 ...
 * 
 */
class Test_Solar_Auth_Adapter_Post extends Test_Solar_Auth_Adapter {
     ...
     * 
     */
    protected $_Test_Solar_Auth_Adapter_Post = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Auth_Adapter_Post');
        $this->assertInstance($obj, 'Solar_Auth_Adapter_Post');
    }
