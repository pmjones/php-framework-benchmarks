 ...
 * 
 */
class Test_Solar_Cli_Help extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Cli_Help = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Cli_Help');
        $this->assertInstance($obj, 'Solar_Cli_Help');
    }
