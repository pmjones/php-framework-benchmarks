 ...
 * 
 */
class Test_Solar_Auth_Adapter_Ldap extends Test_Solar_Auth_Adapter {
     ...
     * 
     */
    protected $_Test_Solar_Auth_Adapter_Ldap = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Auth_Adapter_Ldap');
        $this->assertInstance($obj, 'Solar_Auth_Adapter_Ldap');
    }
