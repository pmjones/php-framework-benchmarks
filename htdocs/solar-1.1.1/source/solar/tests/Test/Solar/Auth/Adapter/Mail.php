 ...
 * 
 */
class Test_Solar_Auth_Adapter_Mail extends Test_Solar_Auth_Adapter {
     ...
     * 
     */
    protected $_Test_Solar_Auth_Adapter_Mail = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Auth_Adapter_Mail');
        $this->assertInstance($obj, 'Solar_Auth_Adapter_Mail');
    }
