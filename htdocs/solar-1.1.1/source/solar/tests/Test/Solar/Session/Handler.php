...
class Test_Solar_Session_Handler extends Solar_Test {
    ...
    public function test__construct()
    {
        ...
        $actual = new Solar_Session_Handler($this->_config);
        $expect = 'Solar_Session_Handler';
    ...
    final public function test__call()
    {
        // we use `new` instead of Solar::factory() so that we get back the
        // factory class itself, not an adapter generated by the factory
        $obj = new Solar_Session_Handler($this->_config);
        try {
            $obj->noSuchMethod();
    ...
    public function testFactory()
    {
        ...
        $expect = 'Solar_Session_Handler_Adapter';
        $this->assertInstance($actual, $expect);
    }
}
