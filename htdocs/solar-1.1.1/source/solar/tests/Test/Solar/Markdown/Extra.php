 ...
 * 
 */
class Test_Solar_Markdown_Extra extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Markdown_Extra = array(
    );
    ...
    {
        $actual = Solar::factory('Solar_Markdown_Extra');
        $expect = 'Solar_Markdown_Extra';
