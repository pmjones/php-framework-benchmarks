 ...
 * 
 */
abstract class Test_Solar_Http_Request_Adapter extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Http_Request_Adapter = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Http_Request_Adapter');
